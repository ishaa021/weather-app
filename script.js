...
const  seachCitySection = document.querySelector('.search-city')
...
const apikey ='857e15450865f11fb5b176df3b69f95c'
...
function showDisplaySection(section){
    [weatherInfoSection,seachCitySection,notFoundSection]
